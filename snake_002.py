...
pygame.display.set_caption("Terceira Versão Snake Game")
...
def draw_snake(snake_list):
    for snake_head in snake_list:
        pygame.draw.rect(game_window, SNAKE_COLOR, [snake_head[0], snake_head[1], SNAKE_SIZE, SNAKE_SIZE])

def display_score(score):
    text = font.render(f'Pontuação: {score}', True, TEXT_COLOR)
